<?php
        ...
        {           
            ...
            $query = "SELECT * FROM product WHERE 1"; //product_id = '$product_id'";
        ...
        <div class="signUpForm">
         <center> <p class="signUpHeading">DELETE PRODUCT</p></center>
          ...
          <label class="text">product id
            <br />
            <input type="text" name="product_id" class="input" required="required" id="emailM" onfocus="this.className += ' inputfocus'"
