...
<li><a href="userdetails.php"><i class="fas fa-sliders-h"></i>User Details</a></li>
    ...
    <div style="margin-top:10px";></div>
       <center><p class="panels">User Details</p></center>
        <div style="margin-top:10px";></div>
       <center> <i class="fa fa-angle-double-down"></i><center>
        <div style="margin-top:5px";></div>
        <div class="signUpForm">
           <p class="signUpH">User Details</p>
...
<?php
                        ...
                        else
                        {
                            ...
                            echo "<thead>";
                            echo "<tr>";
                            echo "<th>User_Name</th> <th>User_Email</th> <th>Delete</th>";
                            echo "</tr>";
                            echo "</thead>";
                            ...
                            while($row=mysqli_fetch_array($result))
                                { 
                                   ...
                                   <td>".$row['username']."</td>
                                   <td>".$row['email']."</td>
                                   <td><a href='deleteuser.php?username=$row[username]'><input class='buu' type='submit' value='Delete'></a></td>
                                   </tr>
                                    </tbody>";
                                } 
                          echo "</table>";
